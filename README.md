# Lukman Fashina
A data and policy professional passionate about helping organizations make better decisions through high quality data asset enabled by strong data governance processes, practice,  and culture. Currently a Data Policy Advisor with the Ontario Public Service, I lead the development of enterprise data governance policies, standards, and tools that strengthen how data is managed, trusted, and used across government.
